...
static void Regkey_ctor(lua_State *L, Regkey *this, HKEY k) {
  ...
  static int l_Regkey___gc(lua_State *L) {
    Regkey *this = Regkey_arg(L,1);
    #line 1749 "winapi.l.c"
    if (this->key != NULL)
      RegCloseKey(this->key);
    return 0;
  }

#line 1754 "winapi.l.c"
